...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("object", 1, "ceiling damage")
        ...
        for a in annotations:
            ...
            objects = map(lambda s: s.strip(), objects)
            print("objects:",objects)
            
            #name_dict = {"bottle": 1,"glass": 2,"paper": 3,"trash": 4}
            
            name_dict = {"ceiling damage": 1}
...
if __name__ == '__main__':
    ...
    if args.weights.lower() == "coco":
        ...
        weights_path = os.path.join(ROOT_DIR, "logs/mask_rcnn_object_0003.h5")
